...
export const UI_COPY = {
  ...
  discussionCompleted: text("讨论已结束", "Discussion Finished"),
  discussionStopped: text("讨论已停止", "Discussion Stopped"),
  discussionEndHint: text("可回到顶部导出纪要或最终结论。", "Jump back to the top to export notes or the final conclusion."),
  scrollToTop: text("回到顶部", "Back to Top"),
  ...
  expandMessage: text("展开全文", "Expand"),
  collapseMessage: text("收起", "Collapse"),
